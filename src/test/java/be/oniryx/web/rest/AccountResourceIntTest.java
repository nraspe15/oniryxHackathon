...
import be.oniryx.config.Constants;
import be.oniryx.OniryxHackathonApp;
import be.oniryx.domain.Authority;
import be.oniryx.domain.User;
import be.oniryx.repository.AuthorityRepository;
import be.oniryx.repository.UserRepository;
import be.oniryx.security.AuthoritiesConstants;
import be.oniryx.service.MailService;
import be.oniryx.service.dto.UserDTO;
import be.oniryx.web.rest.errors.ExceptionTranslator;
import be.oniryx.web.rest.vm.KeyAndPasswordVM;
import be.oniryx.web.rest.vm.ManagedUserVM;
import be.oniryx.service.UserService;
