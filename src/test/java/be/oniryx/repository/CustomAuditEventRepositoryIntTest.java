...
import be.oniryx.config.audit.AuditEventConverter;
import be.oniryx.domain.PersistentAuditEvent;
...
import static be.oniryx.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
